  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-24 right-4 w-14 h-14 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full shadow-lg shadow-blue-500/40 flex items-center justify-center text-white hover:scale-105 active:scale-95 transition-transform z-40"
      >
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black/60 flex items-end justify-center z-50" onClick={handleClose}>
          <div
            className="bg-white rounded-t-3xl w-full max-w-lg max-h-[90vh] overflow-hidden animate-slide-up"
          ...
          >
            ...
            <div className="px-5 pb-5 overflow-y-auto max-h-[calc(90vh-40px)]">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold text-gray-800">快速記帳</h3>
