        ...
        <div className="space-y-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
            ...
            <button
              ...
              className="w-full p-4 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors focus:outline-none border-b dark:border-gray-700"
            >
              <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => setShowConfirmDialog({
                title: '重置分類',
                message: '確定要重置所有分類嗎？這將刪除所有自訂分類並恢復預設值。此操作無法復原。',
                confirmText: '確定重置',
                isDanger: true,
                onConfirm: async () => {
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <div className="font-medium text-orange-600 dark:text-orange-400">重置為預設分類</div>
                  <div className="text-sm text-gray-500 dark:text-gray-400">恢復系統預設的分類設定</div>
                </div>
              </div>
              <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
